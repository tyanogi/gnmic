...
## Phase 3: OpenConfig State Path 優先ロジックの追加 [checkpoint: fa72acc]
- [x] TDD: OpenConfigスタイルの `state` コンテナを持つリストのテストケースを追加する 044f5b7
- [x] 実装: ヒューリスティックに基づいた実機問い合わせ用パス（State Path）の生成ロジックを実装する e8a2ad0
